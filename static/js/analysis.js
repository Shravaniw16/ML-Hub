document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!stored) {
    alert("No analysis data found. Please upload dataset first.");
  ...
  if (data.type === "audio") {
    ...
    document.getElementById("audioChannels").innerText =
      data.channels;
  ...
  if (data.type === "video") {
    ...
    document.getElementById("videoFPS").innerText =
      data.fps;
    ...
    cleanBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        if (!res.ok) {
          ...
          console.error("Clean API error:", text);

          statusText.innerText = "Cleaning failed. Check console.";
        ...
        statusText.innerText = "Cleaning failed.";
  ...
  if (downloadBtn) {
    ...
    downloadBtn.addEventListener("click", () => {
      ...
      window.location.href =
        "/download-clean-data?path=" +
        encodeURIComponent(cleanedFilePath);
